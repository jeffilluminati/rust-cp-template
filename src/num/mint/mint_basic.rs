...
thread_local!(static DYN_MODULUS_U32: UnsafeCell<BarrettReduction<u64>> = UnsafeCell::new(BarrettReduction::<u64>::new_with_im(1_000_000_007, !0 / 1_000_000_007)));
impl DynModuloU32 {
...
thread_local!(static DYN_MODULUS_U64: UnsafeCell<BarrettReduction<u128>> = UnsafeCell::new(BarrettReduction::<u128>::new_with_im(1_000_000_007, !0 / 1_000_000_007)));
impl DynModuloU64 {
